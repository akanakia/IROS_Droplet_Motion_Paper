...
\dot{x}_r &=& \frac{l\dot{\theta_2}}{2}-\frac{l\dot{\theta_1}}{2}\frac{\sqrt{3}}{2}+\frac{l\dot{\theta_0}}{2}\frac{\sqrt{3}}{2}\\
\dot{y}_r &=& \frac{l\dot{\theta_0}}{2}\frac{\sqrt{3}}{2} - \frac{l\dot{\theta_1}}{2}\frac{\sqrt{3}}{2}\\
...
\begin{eqnarray}
\dot{\theta_2}=\frac{2(\dot{x}-\dot{y})}{l}
\end{eqnarray}
and so on.
